  ...
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-12">
        ...
        >
          <h1
            className="text-white mb-4 text-3xl md:text-4xl lg:text-5xl 
          ...
          <p className="text-mycolor-100 text-base mb-6 lg:text-lg">
            ...
            eaque praesentium harum atque sed, eius ducimus facilis a quos quam!
          </p>

          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full md:w-fit rounded-full
            bg-gradient-to-br from-mycolor-200 to-mycolor-100 text-white text-center "
            >
              Hire
            </Link>
            ...
            bg-gradient-to-br from-mycolor-200 to-mycolor-100 text-white text-center mt-3 md:ml-3"
            >
              <span
